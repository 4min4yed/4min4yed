...
![Cybersecurity Skills](https://quickchart.io/chart?c={type:'radar',data:{labels:['Web/API','Network','Hardware','SOC','NetSec'],datasets:[{label:'Skill%27Level',data:[80,75,50,65,70],backgroundColor:'rgba(0,255,128,0.15)',borderColor:'#00ff88',pointBackgroundColor:'#00ff88',pointBorderColor:'#000',pointHoverBackgroundColor:'#fff'}]},options:{plugins:{legend:{labels:{color:'#00ff88',font:{size:14}}}},scales:{r:{angleLines:{color:'rgba(0,255,128,0.2)'},grid:{color:'rgba(0,255,128,0.2)'},pointLabels:{color:'#00ff88',font:{size:13}},ticks:{display:false,min:0,max:100},backgroundColor:'#0d1117'}}}})
