...
![Cybersecurity Skills](https://quickchart.io/chart?c={type:'radar',data:{labels:['Web & API Pentesting','Network Pentesting','Hardware Pentesting','SOC / Blue Team','Network Security'],datasets:[{label:'Skill Level',data:[80,75,50,65,70],backgroundColor:'rgba(31,209,61,0.2)',borderColor:'rgba(31,209,61,1)',pointBackgroundColor:'rgba(31,209,61,1)'}]},options:{scale:{ticks:{beginAtZero:true,max:100}}}})
